            ...
            <form class="row g-3 mb-6" action="{{ route('admin.tenant.store') }}" method="post">
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" name="name" value="{{ old('name') }}" type="text" placeholder="name" required />
                        <label for="floatingInputGrid">Name</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" name="domain" value="{{ old('domain') }}" type="text" placeholder="https://domain.com" required />
                        <label for="floatingInputGrid">Domain</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-8">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" name="notes" value="{{ old('notes') }}" type="text" placeholder="Project title" required />
