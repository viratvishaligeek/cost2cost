            ...
            <form class="row g-3 mb-6" action="{{ route('admin.blog-category.update', encrypt($data->id)) }}" method="post">
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input id="featured_thumbnail" class="form-control" type="text" name="featured"
                            value="{{ old('featured') ?? $data->featured_image }}">
                    </div>
                </div>
                <div class="col-md-4" id="featured_holder">
                    <label for="name"> Preview</label>
                    <img src="{{ old('featured') ?? $data->featured_image }}" alt="" width="100%">
                </div>
                <div class="col-sm-6 col-md-6">
                    <div class="form-floating">
