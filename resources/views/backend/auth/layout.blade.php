...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ URL::asset('backend') }}/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('backend') }}/img/favicons/favicon-16x16.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
        <div class="bg-holder bg-auth-card-overlay" style="background-image:url({{ URL::asset('backend') }}/img/bg/37.png);"></div>
